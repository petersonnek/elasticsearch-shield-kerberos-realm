X-Pack Kerberos Realm
=====================
Kerberos/SPNEGO custom realm for Elasticsearch X-Pack 5.6.3.
...
Configuration is done in elasticsearch.yml
    ...
    xpack.security.authc.realms.kerb.acceptor_keytab_path: /path/to/server.keytab
