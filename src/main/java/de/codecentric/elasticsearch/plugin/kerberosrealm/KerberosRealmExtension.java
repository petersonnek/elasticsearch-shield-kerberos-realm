...
import de.codecentric.elasticsearch.plugin.kerberosrealm.realm.KerberosCachingRealm;
import de.codecentric.elasticsearch.plugin.kerberosrealm.realm.KerberosCachingRealmFactory;
...
public class KerberosRealmExtension extends XPackExtension {
    ...
    public Collection<String> getRestHeaders() {
        return Arrays.asList(KerberosRealm.AUTHORIZATION_HEADER);
    }
    ...
    public Map<String, Factory> getRealms(ResourceWatcherService resourceWatcherService) {
        return new MapBuilder<String, Factory>()
                ...
                .put(KerberosCachingRealm.TYPE, new KerberosCachingRealmFactory())
                .immutableMap();
    }
