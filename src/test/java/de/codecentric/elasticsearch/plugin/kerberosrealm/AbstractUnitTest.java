...
public abstract class AbstractUnitTest extends ESTestCase {
...
//                //.putArray("plugin.types", ShieldPlugin.class.getName(), LicensePlugin.class.getName(),
//                            KerberosRealmPlugin.class.getName())
...
//                                                                     Lists.newArrayList(ShieldPlugin.class,
//                                                                     LicensePlugin.class,
//                                                                     KerberosRealmPlugin.class)).start();
